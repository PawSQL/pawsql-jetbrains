...
public class OptimizeSqlRequestBody {
    ...
    public OptimizeSqlRequestBody(String userKey, String sql, String workspace) {
        this.userKey = userKey;
        this.workload = sql;
        this.workspace = workspace;
        this.singleQueryFlag = true;
        this.queryMode = "plain_sql";
        this.validateFlag = true;
        this.analyzeFlag = true;
        this.deduplicateFlag = true;
        this.updateStatsBeforeValidationFlag = true;
        this.indexOnly = false;
        this.maxMembersForIndexOnly = 5;
        this.maxMembers = 5;
        this.maxPerTable = 5;
        this.maxSpace = 1000;
        this.closeRewrite = false;
    }
